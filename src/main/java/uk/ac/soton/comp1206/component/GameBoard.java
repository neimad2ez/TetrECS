...
public class GameBoard extends GridPane {
    ...
    /**
     * The listener to call when a right click occurs
     */
    ...
    /**
     * Listener for when user presses right click
     * @param rightClickedListener
     */
    private void setOnRightClicked(RightClickedListener rightClickedListener) {
        logger.info("Setting right clicked listener");
        this.rightClickedListener = rightClickedListener;
    }

    /**
     * Fade effect for completed blocks
